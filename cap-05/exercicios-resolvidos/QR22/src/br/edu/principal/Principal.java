...
public class Principal {
	...
	public static void main(String[] args) {
		...
		int idade, tot_f = 0, tot_m = 0, somal = 0, cont_ml = 0,
		cont_m2 = 0, tot = 0, cont_fl = 0, menor_idade = 0;
		String sexo, exp;
		...
		sexo = sc.next();
		System.out.println("Digite a experiencia (S ou N):");
		exp = sc.next();
		...
		System.out.println("Total de mulheres com experiencia: " +
		tot_f);
		...
		System.out.println("Media de idade dos homens com experiência: " + media_idade);
		}
		if (tot_m == 0) {
		...
		System.out.println("Menor idade entre mulheres com experiencia: " + menor_idade);
		sc.close();
		}
		}
